...
{
    class FeedControllerDeleteRatingTest
    {
        ...
        public async Task TestDeleteRatingValid()
        {
            ...
            //ACT
            var actual = await feedController.DeleteRating("") as OkObjectResult;
        ...
        public async Task TestDeleteRatingInValid()
        {
            ...
            //ACT
            var actual = await feedController.DeleteRating("") as BadRequestObjectResult;
        ...
        {
            MockRatingService.Setup(service => service.DeleteRating(It.IsAny<string>())).
