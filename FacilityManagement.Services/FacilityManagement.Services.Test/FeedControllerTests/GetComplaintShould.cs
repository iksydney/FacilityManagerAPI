...
{
    public class GetComplaintShould
    {
        ...
        public async Task TestGetComplaintsValid()
        {
            ...
            //ACT
            var actual = await feedController.GetComplaintsByPage(1, "") as OkObjectResult;
        ...
        public async Task TestGetComplaintsInValid()
        {
            ...
            //ACT
            var actual = await feedController.GetComplaintsByPage(1, "") as BadRequestObjectResult;
        ...
        {
            MockComplaintService.Setup(service => service.GetComplaintsByPage(It.IsAny<int>(), It.IsAny<string>())).
               Returns(Task.FromResult(new Response<Pagination<PaginatedComplaintsDTO>> { Success = state}));
        }
    }
}